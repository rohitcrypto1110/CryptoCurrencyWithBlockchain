...
# Part 1 - Implementing a Blockchain
...
def connect_node():
    ...
    response = {
        'message' : 'All the nodes are now connected. The coins now blockchain contains are:',
...
def replace_chain():
    ...
    if is_chain_replaced is True :
        response = {
            'message' : 'The nodes had different chains and is replaced by the longest one',
